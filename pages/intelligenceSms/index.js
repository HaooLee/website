  ...
  render () {
    ...
    return (
      <>
        ...
        <ProductBanner videoSrc={'/static/video/zndx.mp4'} title={'智能短信'} desc={'带你了解短信新形态,体验营销新玩法'} src={'http://img.teddymobile.cn/www/images/intelligenceSms/banner.png'} customClassName={'sms-banner'}></ProductBanner>
