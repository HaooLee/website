        ...
        <div className="w">
          <div className="sign clearfix">
            <div className="sign__item">
              <img className="sign__item__img" src="https://img.teddymobile.cn/www/images/numberSign/authentication.png" />
            ...
            <div className="sign__item">
              <img className="sign__item__img" src="https://img.teddymobile.cn/www/images/numberSign/complain.png" />
              <div className="sign__item__info">
