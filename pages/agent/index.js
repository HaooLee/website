...
function SampleNextArrow(props) {
  ...
  return (
    <img className={className} onClick={onClick} style={{width:18,height:30,right:-30}} src="https://img.teddymobile.cn/www/images/right.png"/>
  )
}
...
function SamplePrevArrow(props) {
  const { className, style, onClick } = props;
  return (
    <img className={className} onClick={onClick} style={{width:18,height:30,left:-30}} src="https://img.teddymobile.cn/www/images/left.png"/>
  )
}
export default class Agent extends Component {
  constructor(props) {
    ...
    this.state = {
      products: [
        {
          src: 'https://img.teddymobile.cn/www/images/agent/message-icon.png',
          linkTo:'/intelligenceSms',
          name: '智能短信'
        },
        {
          src: 'https://img.teddymobile.cn/www/images/agent/scenic-icon.png',
          linkTo:'/scenicProduct',
          name: '5G场景消息'
        },
        {
          src: 'https://img.teddymobile.cn/www/images/agent/auth-icon.png',
      ...
      footerProducts: [
        {
          src: 'https://img.teddymobile.cn/www/images/agent/quickApp-icon.png',
          linkTo:'/quickAppProduct',
          name: '快应用'
        },
        {
          src: 'https://img.teddymobile.cn/www/images/agent/platform-icon.png',
          linkTo:'/dspProduct',
          name: '全域场景增量营销平台'
        }
      ],
      ...
      partnerList: [
        {
          src: 'https://img.teddymobile.cn/www/images/agent/dianhui.png',
          name: '点惠',
        ...
        {
          src: 'https://img.teddymobile.cn/www/images/agent/zhuoxin.png',
          name: '欣网卓信',
        ...
        {
          src: 'https://img.teddymobile.cn/www/images/agent/wanhao.png',
          name: '万号',
        ...
        {
          src: 'https://img.teddymobile.cn/www/images/agent/weihu.png',
          name: '微呼',
        ...
        {
          src: 'https://img.teddymobile.cn/www/images/agent/bojian.png',
          name: '博见百约',
        ...
        {
          src: 'https://img.teddymobile.cn/www/images/agent/高斯通.png',
          name: '高斯通',
        ...
        <SectionCard title={'合作伙伴遍及全国'} bgc={'#F8FAFF'}>
          <div className="partner">
            <div className="map-img clearfix">
              {/* <img className="map-img__new" src='https://img.teddymobile.cn/www/images/agent/map1.png' />
              <img className="map-img__new" src='https://img.teddymobile.cn/www/images/agent/map2.png' /> */}
              <img className="map-img__new" src='https://img.teddymobile.cn/www/images/agent/map-new.gif' />
            </div>
          </div>
        </SectionCard>
          ...
          <div className="process clearfix">
              <div className="process__item">
                <div className="process__item__content">
                  <img src="https://img.teddymobile.cn/www/images/agent/icon-agent.png" />
                  <p>代理申请</p>
                </div>
              </div>
              ...
              <div className="process__item">
                <div className="process__item__content">
                  <img src="https://img.teddymobile.cn/www/images/agent/icon-assess.png" />
                  <p>分析评估</p>
                </div>
              </div>
              <div className="process__dot">
              ...
              <div className="process__item">
                <div className="process__item__content">
                  <img src="https://img.teddymobile.cn/www/images/agent/icon-talk.png" />
                  <p>合作洽谈</p>
                </div>
              </div>
              <div className="process__dot">
              ...
              <div className="process__item">
                <div className="process__item__content">
                  <img src="https://img.teddymobile.cn/www/images/agent/icon-confirm.png" />
                  <p>确认合作</p>
                </div>
              </div>
              <div className="process__dot">
              ...
              <div className="process__item">
                <div className="process__item__content">
                  <img src="https://img.teddymobile.cn/www/images/agent/icon-cert.png" />
                  <p>授权证书</p>
                </div>
              </div>
          </div>
