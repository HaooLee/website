  ...
  constructor(props) {
    ...
    this.state = {
      ...
      cases: {
        'OTA': [
          {
            src: 'http://img.teddymobile.cn/www/images/case/xiecheng.png',
            title: '携程',
        ...
        'insurance': [
          {
            src: 'http://img.teddymobile.cn/www/images/case/zhaoshang.png',
            title: '招商信诺',
        ...
        'education': [
          {
            src: 'http://img.teddymobile.cn/www/images/case/vipKid.png',
            title: 'VIPKID',
        ...
        'resale': [
          {
            src: 'http://img.teddymobile.cn/www/images/case/watsons.png',
            title: '屈臣氏',
        ...
        'live': [
          {
            src: 'http://img.teddymobile.cn/www/images/case/meituan.png',
            title: '美团',
          ...
          {
            src: 'http://img.teddymobile.cn/www/images/case/eleme.png',
            title: '饿了么',
        ...
        'e-commerce': [
          {
            src: 'http://img.teddymobile.cn/www/images/case/tuhu.png',
            title: '途虎养车',
        ...
        'finance': [
          {
            src: 'http://img.teddymobile.cn/www/images/case/duxiaoman.png',
            title: '度小满金融',
        ...
        'operator': [
          {
            src: 'http://img.teddymobile.cn/www/images/case/zh-liantong.png',
            title: '联通在线',
          ...
          {
            src: 'http://img.teddymobile.cn/www/images/case/zh-yidong.png',
            title: '中移在线',
          ...
          {
            src: 'http://img.teddymobile.cn/www/images/case/zh-dianxin.png',
            title: '中国电信世纪龙',
          ...
          {
            src: 'http://img.teddymobile.cn/www/images/case/zh-yidong-net.png',
            title: '中移互联网',
